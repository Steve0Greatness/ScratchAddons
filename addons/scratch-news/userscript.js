export default async function ({ addon, console, msg }) {
    ...
    */
    ...
    var news = [ ...SAChangelog.map(news => makeGeneral(news, "SA")), ...scratchNews.map(news => makeGeneral(news, "Scratch")) ].sort((a, b) => a.date < b.date).splice(1, 20);
    console.log(news);
